...
export declare const getSingleCourseBySlugController: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
...
export declare const CourseController: {
    ...
    getSingleCourseBySlugController: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
